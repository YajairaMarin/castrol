                            ...
                            <div className="col-lg-8 mb-4">
                                <div className="card shadow-lg my-6">
                                    <div className="card-header py-3">
                                        <h6 className="m-2 font-weight-bold colorfin text-center">DISPONIBILIDAD GASOLINA</h6>
                                    </div>
                                    ...
                                    <form className="user"> 
                                            ...
                                            <div className="form-group row">
                                            <div className="col-sm-6 mb-3 mb-sm-0">
                                                    <label >Cantidad de galones actuales</label> 
                                                </div>
                                                <div className="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <div className="form-group row">
                                            <div className="col-sm-6 mb-3 mb-sm-0">
                                                    <label >Agregar galones en inventario</label> 
                                                </div>
                                                <div className="col-sm-6 mb-3 mb-sm-0">
                                                    <input type="number" min="1" step="any" className="form-control form-control-user" id="exampleFirstName"
                                                      />
